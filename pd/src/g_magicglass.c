...
void magicGlass_drawNew(t_magicGlass *x)
{
    ...
    sys_vgui(".x%lx.c create prect 0 0 0 0 -stroke $pd_colors(magic_glass_bg) "
             "-fill $pd_colors(magic_glass_bg) -tags magicGlassBg\n",
             x->x_c);
    sys_vgui(".x%lx.c create ppolygon 0 0 0 0 0 0 "
             "-fill $pd_colors(magic_glass_bd) -strokewidth 1 "
             "-tags magicGlassLine\n",
             x->x_c);
    sys_vgui(".x%lx.c create text 0 0 -text {} -anchor w "
...
void magicGlass_flashText(t_magicGlass *x)
{
    ...
    sys_vgui(".x%lx.c itemconfigure magicGlassText "
